...
public abstract class Config
{
    ...
    // Duration for which a vehicle would wait before leaving the forecourt
    public static final int VEHICLE_WAITING_TIME = 1500;

    // Capability of a pump to dispense fuel is 1.5 Litres Per Second = 
    public static final double DISPENSING_CAPABILITY = 0.0015;
    ...
    // private  static final int NUMBER_OF_CARS_LEFT_WITHOUT_FUELLING = 0;


    public static final int CHECK_QUEUE_TIMER_DELAY = 1500;
    public static final int DRAWUI_TIMER_DELAY = 1000;
    
    public static final int QUEUE_MAX_VEHICLES = 1;
